...
func TestLocationPCsFormat(t *testing.T) {
	...
	assert.Equal(t, "loc.testLocationsInside.func1:24 at loc.testLocationsInside:25 at loc.TestLocationPCsFormat.func1:52", fmt.Sprintf("%#v", st))
...
func TestLocationPCsFormatString(t *testing.T) {
	...
	assert.Equal(t, "location_stack_test.go:24 at location_stack_test.go:25 at location_stack_test.go:72", st.FormatString(""))

	assert.Equal(t, "loc.testLocationsInside.func1:24 at loc.testLocationsInside:25 at loc.TestLocationPCsFormatString.func1:72", st.FormatString("#"))

	re := `at [\w.-/]*location_stack_test.go:24
at [\w.-/]*location_stack_test.go:25
at [\w.-/]*location_stack_test.go:72
`
